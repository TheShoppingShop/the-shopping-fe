...
<template>
  <div class="w-full mb-8">
    ...
    <div class="flex md:flex-wrap md:gap-4 p-1 md:overflow-visible overflow-x-auto no-scrollbar gap-2">
      <div
        @click="selectCategory(undefined)"
        class="min-w-[7rem] md:w-32 h-28 md:h-40 rounded-xl overflow-hidden cursor-pointer group relative transition-all duration-300 ease-out flex items-center justify-center border border-muted bg-white text-foreground"
        :class="activeCategory === undefined ? 'ring-2 ring-primary ring-offset-2 shadow-lg' : ''"
      >
        <span class="text-sm md:text-base font-semibold text-center">All</span>
      </div>
      ...
      <div
        ...
        class="min-w-[7rem] md:w-32 h-28 md:h-40 rounded-xl overflow-hidden cursor-pointer group relative transition-all duration-300 ease-out"
      ...
      >
        ...
        <div class="relative h-full flex flex-col items-center justify-end p-2 md:p-4 text-white">
          <div class="text-xs md:text-sm font-bold text-center drop-shadow">
            {{ category.name }}
          </div>
        </div>
        <div
        ...
        >
          <div class="absolute top-2 right-2 w-2.5 h-2.5 bg-white rounded-full animate-pulse shadow" />
        </div>
      </div>
    </div>
  </div>
...
<!--            {{ category.name }}-->
<!--          </div>-->
<!--&lt;!&ndash;          <div class="text-xs text-center opacity-90 drop-shadow-md">&ndash;&gt;-->
